 ...
 */
public enum Hbase12xWriterErrorCode implements ErrorCode {
    ...
    KERBEROS_LOGIN_ERROR("Hbasewriter-14", "Kerberos login error.");
    ;
    private final String code;
    private final String description;

    private Hbase12xWriterErrorCode(String code, String description) {
        this.code = code;
